...
def build_drift_receipt(prior_manifest: Mapping[str, Any], candidate_manifest: Mapping[str, Any], prior_projection: Mapping[str, Any], candidate_projection: Mapping[str, Any]) -> dict[str, Any]:
